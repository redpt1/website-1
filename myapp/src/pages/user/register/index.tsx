...
const Register: FC = () => {
  ...
  const checkPassword = (_: any, value: string) => {
    ...
    if (!value) {
      setVisible(!!value);
      return promise.reject('Please entry your password!');
    }
    // 有值的情况
    if (!visible) {
      setVisible(!!value);
    ...
    <div className={styles.main}>
      ...
      <Form form={form} name="UserRegister" onFinish={onFinish}>
            ...
            visible && (
              <div style={{ padding: '4px 0' }}>
                ...
                <div style={{ marginTop: 10 }}>
                  <span>Enter at least 6 characters. Please don't use passwords that can be easily guessed.</span>
                </div>
              </div>
            )
          }
        ...
        >
          ...
          >
            <Input size="large" type="password" placeholder="Please enter password" />
          </FormItem>
        </Popover>
        <FormItem
          name="confirm"
        ...
        >
          <Input size="large" type="password" placeholder="Please enter password again" />
        </FormItem>
        {/*<InputGroup compact>*/}
        ...
        <FormItem>
          ...
          <Link className={styles.login} to="/user/login">
            <span>Already have?  log in here</span>
          </Link>
        </FormItem>
      </Form>
    </div>
